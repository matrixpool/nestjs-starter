...
export const validationSchema = Joi.object({
  ...
  SQLDB_PASSWORD: Joi.string()
    ...
    .required(),
  SQLDB_DATABASE: Joi.string().required().default(`${PROJECT_NAME}`),
  ...
  JWT_USER_ACCESS_TOKEN: Joi.string()
    .pattern(new RegExp(accessTokenRegExp))
    .required(),
  JWT_USER_REFRESH_TOKEN: Joi.string()
    .pattern(new RegExp(refreshTokenRegExp))
    .required(),
  JWT_ADMIN_ACCESS_TOKEN: Joi.string()
    .pattern(new RegExp(accessTokenRegExp))
    .required(),
  JWT_ADMIN_REFRESH_TOKEN: Joi.string()
    .pattern(new RegExp(refreshTokenRegExp))
    .required(),
